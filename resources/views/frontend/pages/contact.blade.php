...
@section('main-content')
	...
	<div class="map-section">
		<div id="myMap">
			<iframe src="https://www.google.fr/maps/@30.9266181,-8.1395867,16.88z?entry=ttu" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
